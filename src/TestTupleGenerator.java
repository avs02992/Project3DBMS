 ...
 * defined in the
 * Kifer, Bernstein and Lewis 2006 database textbook (see figure 3.6). The
 * primary keys
 * (see figure 3.6) and foreign keys (see example 3.2.2) are as given in the
 * textbook.
 */
public class TestTupleGenerator {
    ...
    public static void main(String[] args) {
        ...
        // add relational schemas for Student, Professor, Course, Teaching and
        // Transcript
