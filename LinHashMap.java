...
public class LinHashMap <K, V>
     ...
     * @param by_get indicates whether 'find' is called from 'get' (performance monitored)
    ...
    private int h(Object key) {
        ...
        //calculate the hash value using the hashCode of the key and the current modulus 'mod1'
